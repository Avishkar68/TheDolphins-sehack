  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-left-4 duration-500">
      <div className="flex items-center justify-between">
            ...
            <div className={`flex items-center space-x-3 px-4 py-2 rounded-xl bg-opacity-10 border ${currentStatus === 'Safe' ? 'bg-emerald-500 text-emerald-400 border-emerald-500/20' : 'bg-red-500 text-red-400 border-red-500/20'}`}>
